 ...
 */
public class NormalTextureShader extends BaseShader {
    ...
    public NormalTextureShader(final Renderable renderable, final ShaderProgram shaderProgramModelBorder)  {
        ...
        register(Inputs.normalTexture, Setters.normalTexture);
    }
