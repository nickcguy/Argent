...
public class DynamicShader extends BaseShader {
    ...
    public DynamicShader(ShaderProgram shader, Renderable renderable) {
        this.program = shader;
    ...
    public void register() {
        ...
        map = AppUtils.Shader.detectUniforms(program.getVertexShaderSource(), program.getFragmentShaderSource());
